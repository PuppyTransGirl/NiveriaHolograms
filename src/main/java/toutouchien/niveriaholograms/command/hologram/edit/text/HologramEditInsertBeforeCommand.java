...
public class HologramEditInsertBeforeCommand extends SubCommand {
	public HologramEditInsertBeforeCommand() {
		super(new CommandData("insertbefore", "niveriaholograms")
				.playerRequired(true)
				.usage("<ligne> <texte>"));
	}
